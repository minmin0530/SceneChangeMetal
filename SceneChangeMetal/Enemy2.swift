...
//        Rotation(axis: [ 0.0, 1.0, 0.0], angle: 0.0, speed: 0.01),
    ...
    var originalData: [[Original]] = [
        ...
        // head
        [Original(position: [ 0.0,  5.0/3.0, 1.0/3.0])],
        [Original(position: [ 0.0,  9.0/3.0,-2.0/3.0])],
        [Original(position: [ 0.0, 13.0/3.0, 1.0/3.0])],
        [Original(position: [ 0.0,  9.0/3.0, 2.0/3.0])],
        // eyes
        [Original(position: [ 4.1/3.0, 10.0/3.0, 1.0/3.0])],
        [Original(position: [-4.1/3.0, 10.0/3.0, 1.0/3.0])],
        // hands
        [Original(position: [ 5.0/3.0, 2.0/3.0, 3.0/3.0])],
        [Original(position: [-5.0/3.0, 2.0/3.0, 3.0/3.0])],
        // foots
        [Original(position: [ 5.0/3.0,-6.0/3.0, -3.0/3.0])],
        [Original(position: [-5.0/3.0,-6.0/3.0, -3.0/3.0])],
        // tail
...
//        Position(x:0.0, y:5.0, z:-5.0),
    ...
    var cubeData = [
        // body
        Cube(r:0.0,g:1.0,b:0.0,a:1.0,sx:4.0/3.0,sy:4.0/3.0,sz:6.0/3.0),

        // head
        Cube(r:0.0,g:0.5,b:0.0,a:1.0,sx:4.0/3.0,sy:1.0/3.0,sz:4.0/3.0),
        Cube(r:0.0,g:0.5,b:0.0,a:1.0,sx:4.0/3.0,sy:3.0/3.0,sz:1.0/3.0),
        Cube(r:0.0,g:0.5,b:0.0,a:1.0,sx:4.0/3.0,sy:1.0/3.0,sz:4.0/3.0),
        ...
        // hands
        Cube(r:0.7,g:0.7,b:0.0,a:1.0,sx:3.0/3.0,sy:3.0/3.0,sz:3.0/3.0),
        Cube(r:0.7,g:0.7,b:0.0,a:1.0,sx:3.0/3.0,sy:3.0/3.0,sz:3.0/3.0),
