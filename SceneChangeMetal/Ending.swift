...
class Ending : BaseScene {
    ...
    var goalCount: Int = 0
    var labelEnd: UILabel = UILabel(frame: CGRect(x: 150, y: 350, width: 600, height: 200))
    var labelGoal: UILabel = UILabel(frame: CGRect(x: 150, y: 300, width: 600, height: 200))
...
//        metalKitView.addSubview(buttonRight)
        ...
        labelEnd.text = "programer Yoshiki Izumi"
        labelEnd.textColor = UIColor.red
        mtkView?.addSubview(labelEnd)
