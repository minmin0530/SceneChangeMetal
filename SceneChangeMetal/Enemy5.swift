...
class Enemy5 {
    ...
    var spinData: [Rotation] = [
        // body
        Rotation(axis: [ 0.0, 1.0, 0.0], angle: -70.0, speed: 0.01),
        // button
        Rotation(axis: [ 0.0, 1.0, 0.0], angle: -70.0, speed: 0.01),
        Rotation(axis: [ 0.0, 1.0, 0.0], angle: -70.0, speed: 0.01),
        Rotation(axis: [ 0.0, 1.0, 0.0], angle: -70.0, speed: 0.01),
...
//
    ...
    var originalData: [[Original]] = [
        ...
        // button
        [Original(position: [ 0.0, 4.0/3.0, 8.0/3.0])],
        [Original(position: [ 4.0/3.0, 2.0/3.0, 8.0/3.0])],
        [Original(position: [-4.0/3.0, 2.0/3.0, 8.0/3.0])],
        [Original(position: [ 0.0, 0.0, 8.0/3.0])],
        [Original(position: [ 0.0,-4.0/3.0, 8.0/3.0])],

        // head
        [Original(position: [ 0.0,  12.0/3.0, 1.0/3.0])],
//        [Original(position: [ 0.0,  9.0/3.0,-2.0/3.0])],
//        [Original(position: [ 0.0, 13.0/3.0, 1.0/3.0])],
//        [Original(position: [ 0.0,  9.0/3.0, 2.0/3.0])],
        // eyes
        [Original(position: [ 2.0/3.0, 14.0/3.0, 6.0/3.0])],
        [Original(position: [-2.0/3.0, 14.0/3.0, 6.0/3.0])],
        
        // mouth
        [Original(position: [ 0.0/3.0, 10.0/3.0, 6.0/3.0])],

        // horn
        [Original(position: [ 2.0/3.0, 18.0/3.0, 0.0])],
        [Original(position: [-2.0/3.0, 18.0/3.0, 0.0])],


        // hands
        [Original(position: [ 11.0/3.0, 8.0/3.0, 0.0])],
        [Original(position: [-11.0/3.0, 8.0/3.0, 0.0])],
        // foots
        [Original(position: [ 8.0/3.0,-11.0/3.0, 0.0])],
        [Original(position: [-8.0/3.0,-11.0/3.0, 0.0])],
        // tail
        [Original(position: [ 0.0,  -4.0/3.0,-9.0/3.0])],
...
//        Position(x:0.0, y:5.0, z:-5.0),
    ...
    var cubeData = [
        // body
        Cube(r:1.0,g:0.0,b:0.0,a:1.0,sx:7.0/3.0,sy:7.0/3.0,sz:7.0/3.0),

        // button
        Cube(r:0.0,g:0.0,b:0.0,a:1.0,sx:1.0/3.0,sy:1.0/3.0,sz:1.0/3.0),
        Cube(r:0.0,g:0.0,b:0.0,a:1.0,sx:1.0/3.0,sy:1.0/3.0,sz:1.0/3.0),
        Cube(r:0.0,g:0.0,b:0.0,a:1.0,sx:1.0/3.0,sy:1.0/3.0,sz:1.0/3.0),
        Cube(r:0.0,g:0.0,b:0.0,a:1.0,sx:1.0/3.0,sy:1.0/3.0,sz:1.0/3.0),
        Cube(r:0.0,g:0.0,b:0.0,a:1.0,sx:1.0/3.0,sy:1.0/3.0,sz:1.0/3.0),
        ...
        // head
        Cube(r:0.5,g:0.0,b:0.0,a:1.0,sx:5.0/3.0,sy:5.0/3.0,sz:5.0/3.0),
//        Cube(r:0.5,g:0.0,b:0.0,a:1.0,sx:4.0/3.0,sy:3.0/3.0,sz:1.0/3.0),
//        Cube(r:0.5,g:0.0,b:0.0,a:1.0,sx:4.0/3.0,sy:1.0/3.0,sz:4.0/3.0),
//        Cube(r:0.7,g:0.7,b:0.0,a:1.0,sx:4.0/3.0,sy:3.0/3.0,sz:3.0/3.0),
//
        // eyes
        Cube(r:0.0,g:0.0,b:0.0,a:1.0,sx:1.0/3.0,sy:1.0/3.0,sz:1.0/3.0),
        Cube(r:0.0,g:0.0,b:0.0,a:1.0,sx:1.0/3.0,sy:1.0/3.0,sz:1.0/3.0),
        ...
        // mouth
        Cube(r:0.0,g:0.0,b:0.0,a:1.0,sx:3.0/3.0,sy:1.0/3.0,sz:1.0/3.0),

        // horn
        Cube(r:0.0,g:0.0,b:0.0,a:1.0,sx:1.0/3.0,sy:2.0/3.0,sz:1.0/3.0),
        Cube(r:0.0,g:0.0,b:0.0,a:1.0,sx:1.0/3.0,sy:2.0/3.0,sz:1.0/3.0),

//
        // hands
        Cube(r:0.5,g:0.0,b:0.0,a:1.0,sx:4.0/3.0,sy:4.0/3.0,sz:4.0/3.0),
        Cube(r:0.5,g:0.0,b:0.0,a:1.0,sx:4.0/3.0,sy:4.0/3.0,sz:4.0/3.0),
...
//
        // tail
        Cube(r:0.0,g:0.0,b:0.0,a:1.0,sx:1.0/3.0,sy:1.0/3.0,sz:3.0/3.0),
        
        //        Cube(r:0.1,g:0.0,b:0.0,a:1.0,sx:3.0/3.0,sy:1.0/3.0,sz:2.0/3.0),
        //        Cube(r:0.1,g:0.0,b:0.0,a:1.0,sx:3.0/3.0,sy:1.0/3.0,sz:2.0/3.0),
